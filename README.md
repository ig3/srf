...
each card) or five review cards are studied in a row (i.e. without any new
card) or five minutes elapses without reviewing a card (i.e. if you simply
stop studying for five minutes).
