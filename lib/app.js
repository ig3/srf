...
module.exports = (srf, options = {}) => {
  ...
  app.get('/homeData', (req, res) => {
    ...
    const schedulerStats = srf.getSchedulerStats();
    res.json({
      statsPast24Hours: statsPast24Hours,
      averageLatency: srf.getAverageLatency(),
      averageStudyTime: schedulerStats.averageStudyTimePerDay,
      averageNewCards: schedulerStats.averageNewCardsPerDay,
      ...
      cardsDueNext24Hours: schedulerStats.cardsDueNext24Hours,
      studyTimeNext24Hours: schedulerStats.predictedStudyTime,
      reviewsBetweenNewCards: schedulerStats.reviewsBetweenNewCards,
      reviewsToNextNew: schedulerStats.reviewsToNextNew,
    });
  });
  ...
  app.get('/stats', (req, res) => {
    ...
    const newCardsShortTermAverage = 
      srf.getSchedulerStats().averageNewCardsPerDay;
    ...
    res.json({
      ...
      averageStudyTimePerDay: schedulerStats.averageStudyTimePerDay,
      averageStudyTimePerCard:
        schedulerStats.averageStudyTimePerCard.toFixed(1),
      averageReviewsPerCard: schedulerStats.averageReviewsPerCard,
      averageReviewsPerDay: schedulerStats.averageReviewsPerDay,
      timeToNextDue: nextDue - now,
      charts: charts,
      theme: config.theme,
      reviewsBetweenNewCards: schedulerStats.reviewsBetweenNewCards,
  ...
  app.get('/card/:id', (req, res) => {
    ...
    if (card) {
      ...
      const schedulerStats = srf.getSchedulerStats();
      card.reviewsToNextNew = schedulerStats.reviewsToNextNew;
      card.studyTimeNext24Hours = schedulerStats.predictedStudyTime;
