...
/**
 * getWeightedAverageStudyTime returns the average study time per day
 * over the given number of days of study (ignoring days without study),
 * using an exponential weighting factor.
 */
function getWeightedAverageStudyTime (days = 7) {
  return this.scheduler.getWeightedAverageStudyTime(days);
}
