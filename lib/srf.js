...
// TODO: move this to scheduler.getStats
function getAverageStudyTimePerCard () {
  return this.scheduler.getAverageStudyTimePerCard();
}
...
function getAverageNewCardsPerDay (days) {
  return this.scheduler.getAverageNewCardsPerDay(days);
}

function getAverageReviewsPerCard (days) {
  return this.scheduler.getAverageReviewsPerCard(days);
}

function getAverageReviewsPerDay (days) {
  return this.scheduler.getAverageReviewsPerDay(days);
}
...
function getPercentCorrect (
  ...
  if (result && result.count > config.minPercentCorrectCount) {
...
/**
 * getAverageStudyTimePerDay returns the average total study time per day
 * over a sliding window of the given number of days, ending at current
 * time.
 */
function getAverageStudyTimePerDay (days) {
  return this.scheduler.getAverageStudyTimePerDay(days);
}
